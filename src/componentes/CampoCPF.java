...
public class CampoCPF extends JFormattedTextField implements Componente {
  ...
  public boolean isVazio() {
    return getValor().equals("___.___.___-__");
  }

  @Override
  public boolean isValido() {
    return getValor().replace(".", "").replace("-", "").replace("_", "").length() == 11;
  }
